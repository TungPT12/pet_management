...
* You have installed nodejs version ^18.14.2 (https://nodejs.org/en/download/). 
* You have installed of VSCode (https://visualstudio.microsoft.com/downloads).
* You have installed Live Server in VSCode (https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer).

### Install

* Clone project
* Click right mouse in index.html.
